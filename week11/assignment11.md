...
3. Browse through the list of files and directories until you find a `.py` file (or multiple ones). The file should at least has more than 100 lines for you to have enough content to read.
...
## Fix your GitHub Repository
- If there is still any Python files without extension names, space in the folders...take this chance to fix them!
